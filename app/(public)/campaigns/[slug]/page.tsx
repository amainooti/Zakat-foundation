...
export default async function CampaignDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <div style={{ background: "#0D0D0D", minHeight: "100vh" }}>
      ...
      {/* Cover */}
      {c.cover_image && (
        <div style={{ position: "relative", height: "clamp(280px, 40vw, 500px)", overflow: "hidden" }}>
          <img
            src={c.cover_image}
            alt={c.title}
      ...
      <div
        style={{
          ...
          padding: c.cover_image ? "0 clamp(24px, 6vw, 80px) 80px" : "64px clamp(24px, 6vw, 80px) 80px",
          display: "grid",
          gridTemplateColumns: "1fr 380px",
          gap: "60px",
          alignItems: "start",
          marginTop: c.cover_image ? "-80px" : "0",
