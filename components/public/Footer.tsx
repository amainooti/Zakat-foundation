...
export default function Footer({ settings }: { settings: SiteSettings }) {
  ...
  const socials = [
    { key: "footer_social_twitter",   label: "X",         href: settings.footer_social_twitter },
    { key: "footer_social_instagram", label: "Instagram",  href: settings.footer_social_instagram },
    { key: "footer_social_facebook",  label: "Facebook",   href: settings.footer_social_facebook },
    { key: "footer_social_youtube",   label: "YouTube",    href: settings.footer_social_youtube },
  ].filter((s) => s.href);
      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
        ...
        >
          ...
          <div>
            <p
              style={{
                ...
                color: "#F0EDE8", marginBottom: "10px",
              }}
            >
              {siteName}
            </p>
          ...
          <div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
              {email && (
                <a href={`mailto:${email}`} style={{ fontSize: "13px", color: "#706B63", textDecoration: "none" }}>
                  {email}
                </a>
              )}
              {phone && (
                <a href={`tel:${phone}`} style={{ fontSize: "13px", color: "#706B63", textDecoration: "none" }}>
                  {phone}
                </a>
              )}
              {address && (
                <p style={{ fontSize: "13px", color: "#4A4540", lineHeight: 1.6, whiteSpace: "pre-line" }}>
                  {address}
                </p>
              )}
            </div>
