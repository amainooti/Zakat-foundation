  ...
  return (
    ...
    >
      ...
      <div style={{ padding: "20px", flex: 1, display: "flex", flexDirection: "column", gap: "12px" }}>
        <h3 style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: "20px", fontWeight: 600, color: "#F0EDE8", lineHeight: 1.25 }}>
          {campaign.title}
        </h3>
        ...
        <div style={{ marginTop: "auto", paddingTop: "4px" }}>
          <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "8px" }}>
            <span style={{ fontSize: "13px", fontWeight: 600, color: "#F0EDE8", fontFamily: "'DM Mono', monospace" }}>
    ...
    <section style={{ padding: "96px clamp(24px, 6vw, 80px)", maxWidth: "1200px", margin: "0 auto" }}>
      <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", marginBottom: "48px", gap: "24px", flexWrap: "wrap" }}>
        <div>
          ...
          <h2 style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: "clamp(32px, 4vw, 48px)", fontWeight: 600, color: "#F0EDE8", lineHeight: 1.1 }}>
            {heading}
          </h2>
          {subheading && (
            <p style={{ fontSize: "15px", color: "#706B63", marginTop: "10px", maxWidth: "480px" }}>{subheading}</p>
          )}
        </div>
        <a href="/campaigns" style={{ fontSize: "13px", fontWeight: 600, color: "#C9952A", textDecoration: "none", letterSpacing: "0.06em", whiteSpace: "nowrap" }}>
          All campaigns →
        </a>
      </div>
