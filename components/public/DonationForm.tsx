    ...
    <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
        ...
        <div style={{ position: "relative" }}>
          ...
          <input
            ...
            style={{
              ...field,
              paddingLeft: "24px",
              borderColor: isCustom ? "#C9952A" : "#2A2A2A",
            }}
          />
        </div>
      ...
      >
        ...
        <div
          style={{
            ...
            background: isRecurring ? "#C9952A" : "#2A2A2A",
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
        ...
        <div>
          ...
          />
          <p style={{ fontSize: "11px", color: "#706B63", marginTop: "4px" }}>
      ...
      >
        {loading ? (
          ...
          <>
            <Heart size={16} />
            {isRecurring ? `Give ${formatCurrency(finalAmount || 0)} / month` : `Donate ${formatCurrency(finalAmount || 0)}`}
          </>
        )}
      </button>
